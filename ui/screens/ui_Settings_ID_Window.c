...
ui_ID_Setting_Enter_Btn2 = lv_btn_create(ui_Settings_ID_Window);
lv_obj_set_width( ui_ID_Setting_Enter_Btn2, 60);
lv_obj_set_height( ui_ID_Setting_Enter_Btn2, 60);
lv_obj_set_x( ui_ID_Setting_Enter_Btn2, 175 );
lv_obj_set_y( ui_ID_Setting_Enter_Btn2, -129 );
lv_obj_set_align( ui_ID_Setting_Enter_Btn2, LV_ALIGN_CENTER );
lv_obj_set_flex_flow(ui_ID_Setting_Enter_Btn2,LV_FLEX_FLOW_ROW);
lv_obj_set_flex_align(ui_ID_Setting_Enter_Btn2, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
lv_obj_add_flag( ui_ID_Setting_Enter_Btn2, LV_OBJ_FLAG_SCROLL_ON_FOCUS );   /// Flags
lv_obj_clear_flag( ui_ID_Setting_Enter_Btn2, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_SCROLLABLE );    /// Flags
lv_obj_set_style_shadow_color(ui_ID_Setting_Enter_Btn2, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_shadow_opa(ui_ID_Setting_Enter_Btn2, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_bg_color(ui_ID_Setting_Enter_Btn2, lv_color_hex(0x4893EF), LV_PART_MAIN | LV_STATE_PRESSED );
lv_obj_set_style_bg_opa(ui_ID_Setting_Enter_Btn2, 255, LV_PART_MAIN| LV_STATE_PRESSED);

ui_ID_Setting_Enter_Icon2 = lv_img_create(ui_ID_Setting_Enter_Btn2);
lv_img_set_src(ui_ID_Setting_Enter_Icon2, &ui_img_1260392355);
lv_obj_set_width( ui_ID_Setting_Enter_Icon2, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_ID_Setting_Enter_Icon2, LV_SIZE_CONTENT);   /// 1
lv_obj_set_align( ui_ID_Setting_Enter_Icon2, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_ID_Setting_Enter_Icon2, LV_OBJ_FLAG_ADV_HITTEST );   /// Flags
lv_obj_clear_flag( ui_ID_Setting_Enter_Icon2, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_add_event_cb(ui_ID_Setting_Enter_Btn2, ui_event_ID_Setting_Enter_Btn2, LV_EVENT_ALL, NULL);
