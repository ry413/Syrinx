...
ui_Header_Guide_Volume_Icon = lv_img_create(ui_Header_Guide);
lv_img_set_src(ui_Header_Guide_Volume_Icon, &ui_img_490182776);
lv_obj_set_width( ui_Header_Guide_Volume_Icon, LV_SIZE_CONTENT);  /// 22
lv_obj_set_height( ui_Header_Guide_Volume_Icon, LV_SIZE_CONTENT);   /// 20
lv_obj_set_x( ui_Header_Guide_Volume_Icon, 160 );
lv_obj_set_y( ui_Header_Guide_Volume_Icon, 0 );
lv_obj_set_align( ui_Header_Guide_Volume_Icon, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_Header_Guide_Volume_Icon, LV_OBJ_FLAG_ADV_HITTEST );   /// Flags
lv_obj_clear_flag( ui_Header_Guide_Volume_Icon, LV_OBJ_FLAG_SCROLLABLE );    /// Flags

ui_Header_Guide_Volume_Value = lv_label_create(ui_Header_Guide);
lv_obj_set_width( ui_Header_Guide_Volume_Value, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_Header_Guide_Volume_Value, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_Header_Guide_Volume_Value, 415 );
lv_obj_set_y( ui_Header_Guide_Volume_Value, 0 );
lv_obj_set_align( ui_Header_Guide_Volume_Value, LV_ALIGN_LEFT_MID );
lv_label_set_text(ui_Header_Guide_Volume_Value,"79");
lv_obj_set_style_text_color(ui_Header_Guide_Volume_Value, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_Header_Guide_Volume_Value, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_Header_Guide_Volume_Value, &ui_font_LanTing18, LV_PART_MAIN| LV_STATE_DEFAULT);
